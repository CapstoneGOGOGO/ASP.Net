<%@ Page Title="" Language="C#" MasterPageFile="~/layout.master" AutoEventWireup="true" CodeFile="thongtintaikhoan.aspx.cs" Inherits="content_thongtintaikhoan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Header" runat="Server">
    <title>CGV | Thông tin tài khoản</title>
</asp:Content>
        ...
        <div class="col-md-10">
            <div class="card cgv-card">
                <div class="card-header cgv-card-header">
                    <i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right: 11px;"></i>Sửa thông tin tài khoản
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <select class="form-control">
                                                <option value="" selected="selected" disabled="disabled">Ngày</option>
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control">
                                                <option value="" selected="selected" disabled="disabled">Tháng</option>
                                                <option value="01">01</option>
                                                <option value="02">02</option>
                                                <option value="03">03</option>
                                                <option value="04">04</option>
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control">
                                                <option value="" selected="selected" disabled="disabled">Năm</option>
